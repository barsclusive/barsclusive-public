...
editImageLbl:‘Bild ändern (optional)’, imageLbl:‘Bild (optional)’, fromTimeLbl:‘Von (Uhrzeit)’, toTimeLbl:‘Bis (Uhrzeit)’, timeSlotsLbl:‘Zeitfenster’, slotMorning:‘Morgen’, slotMidday:‘Mittag’, slotEvening:‘Abend’, orCustomTimes:‘Oder eigene Zeiten:’
},
en: {
...
editImageLbl:‘Cambiare immagine (opzionale)’, imageLbl:‘Immagine (opzionale)’, fromTimeLbl:‘Da (orario)’, toTimeLbl:‘A (orario)’, timeSlotsLbl:‘Fasce orarie’, slotMorning:‘Mattina’, slotMidday:‘Pranzo’, slotEvening:‘Sera’, orCustomTimes:‘Oppure orari personalizzati:’
},
fr: {
...
editImageLbl:‘Changer l'image (optionnel)’, imageLbl:‘Image (optionnel)’, fromTimeLbl:‘De (heure)’, toTimeLbl:’\u00c0 (heure)’, timeSlotsLbl:‘Cr\u00e9neaux horaires’, slotMorning:‘Matin’, slotMidday:‘Midi’, slotEvening:‘Soir’, orCustomTimes:‘Ou horaires personnalis\u00e9s :’
}
};
...
[t(‘activeDeals’), *barStatsDeals, ‘#fff’, null]
].forEach(function(s) {
var card = document.createElement(‘div’); card.className = ‘stat-card’;
var lEl = document.createElement(‘div’); lEl.className = ‘stat-label’; lEl.textContent = s[0];
...
renderVoucherPanel*(‘overviewVoucherPanel’, items);
}
